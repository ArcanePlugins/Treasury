...
class MigrationData {
    ...
    private final @NotNull AtomicInteger genericAccountsProcessed = new AtomicInteger();
    ...
    @NotNull AtomicInteger genericAccountsProcessed() {
        return genericAccountsProcessed;
    }
