...
package me.lokka30.treasury.plugin.velocity.hooks.miniplaceholders;
...
import me.lokka30.treasury.plugin.velocity.VelocityTreasuryPlugin;
...
public class MiniPlaceholdersHook implements Hook {
    ...
    public boolean register() {
        PlaceholdersConfig config = MiniPlaceholdersConfig.load(new File(
                ((VelocityTreasuryPlugin) VelocityTreasuryPlugin.getInstance()).getDataDirectory().toFile(),
